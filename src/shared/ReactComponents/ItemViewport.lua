...
local function ItemViewport(props: ItemViewportProps)
	...
	useEffect(function()
		...
		local modelTemplate = modelsFolder:FindFirstChild(ItemId) or modelsFolder:FindFirstChild("Error")
		...
		-- Adjust field of view to fit the model
			...
			warn("[ItemViewport] Model not found for ItemId:", ItemId)
		end
		-- Cleanup function
		return function()
