    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/20">
      ...
      <section className="py-20 container mx-auto px-4 bg-muted/30">
        <div className="text-center mb-12 space-y-4">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight">My <span className="text-primary">Game</span></h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Check out my published Roblox game
          </p>
        </div>
            ...
            <div className="border rounded-lg overflow-hidden bg-card hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="p-6 space-y-3">
                ...
                <div className="flex gap-2 flex-wrap">
                  <span className="text-xs px-3 py-1 rounded-full bg-primary/10 text-primary">Adventure</span>
                  <span className="text-xs px-3 py-1 rounded-full bg-primary/10 text-primary">Multiplayer</span>
                </div>
              </div>
            </div>
          </a>
